...
color_foreground="7c/6f/54" # Base 02
color_background="fb/f1/c7" # Base 07
color_cursor="7c/6f/54" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 7c6f54 # forground
  printf $printf_template_custom Ph fbf1c7 # background
  printf $printf_template_custom Pi 7c6f54 # bold color
  printf $printf_template_custom Pj d5c4a1 # selection color
  printf $printf_template_custom Pk 7c6f54 # selected text color
  printf $printf_template_custom Pl 7c6f54 # cursor
